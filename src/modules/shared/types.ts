...
type VersionGenerationBase = {
  ...
  audioUrl?: string;
  /** Digest of the exact generated bytes selected for save/evidence linkage. */
  audioSha256?: string;
  durationSec: number;
  batchIndex: number;
  styleMix: number;
...
export type SongProvenance = {
  ...
  /** Digest of the exact generated clip saved into this artifact. */
  generationAudioSha256?: string;
