  ...
  return (
    <div className="rounded-md border border-[#E7DCCB] bg-[#FFFCF7] p-4">
      <div className="mb-3 flex items-center gap-2">
        ...
        <p className="text-[11px] uppercase tracking-[0.16em] text-[#8C8780]">Runtime diagnostics</p>
      </div>
    ...
    <div className="rounded-md border border-[#E7DCCB] bg-[#FFFCF7] p-4">
      <div className="mb-3 flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <p className="text-[11px] uppercase tracking-[0.16em] text-[#8C8780]">i18n tokens</p>
        </div>
