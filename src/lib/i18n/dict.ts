...
export const DICT = {
  ...
  "checkout.headline.review":    { zh: "确认这次补给。",       en: "Review your top up." },
  ...
  "checkout.review_subcopy":     { zh: "像小票一样再看一眼，然后交给安全支付页。", en: "A receipt-shaped check before the secure payment page." },
  "checkout.requesting_subcopy": { zh: "正在连接 {provider}。", en: "Connecting to {provider}." },
  "checkout.awaiting_subcopy":   { zh: "支付信息从这里交给 {provider} 处理。", en: "{provider} has the payment details from here." },
  "checkout.confirming_subcopy": { zh: "支付方正在确认订单，Murmur 正在等待账本到账。", en: "The provider is confirming the order; Murmur is waiting for the ledger." },
  "checkout.success_subcopy":    { zh: "音磅已经挂到这个账号上。", en: "Your notes are attached to this account." },
  "checkout.canceled_subcopy":   { zh: "没有扣款，也没有改动你的余额。", en: "Nothing was charged." },
  "checkout.failed_subcopy":     { zh: "可以重试，或者回去换一条支付路线。", en: "You can retry or choose another route." },
  ...
  "checkout.receipt":            { zh: "小票", en: "Receipt" },
  ...
  "checkout.email_missing":      { zh: "需要登录邮箱", en: "Receipt email required" },
  ...
  "checkout.provider_note":      { zh: "支付详情由安全支付方处理；Murmur 只保存收据和到账状态。", en: "Payment details are handled by the secure provider. Murmur only stores the receipt state." },
  "checkout.stage.review":       { zh: "确认", en: "Review" },
  "checkout.stage.pay":          { zh: "支付", en: "Pay" },
  "checkout.stage.confirm":      { zh: "到账", en: "Confirm" },
