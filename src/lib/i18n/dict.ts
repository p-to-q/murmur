...
export const DICT = {
  ...
  "me.manifesto.eyebrow":  { zh: "把跑调的人类，接入音乐宇宙。", en: "A QUIET PLACE" },
  "me.manifesto.headline": { zh: "Murmur 是一个从哼唱开始的音乐创作产品，关注歌曲创作里最早、也最容易丢失的那个瞬间：旋律刚刚出现的时候。", en: "No ads, no feeds, no algorithm, no likes." },
  "me.manifesto.body":     { zh: "把你那段七扭八歪但有灵魂的旋律捞起来。修顺，编曲，加鼓，加贝斯，加弦乐，最后变成一张可以播放、下载、收藏、分享的歌曲专辑。", en: "A tiny private space for the songs you hum and almost forget. Every recording stays yours — shared only when you feel like it." },
  ...
  "me.about.desc":         { zh: "Murmur是一个负责把你脑子里的歌变成真的，面向普通创作者的 humming-to-song 音乐创作工具。", en: "Turn your hummed melody into a little song you can keep and share." },
