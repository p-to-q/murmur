...
export const DICT = {
  ...
  "nav.notify.desc":   { zh: "开启浏览器提醒，也能在这里查看最近动态", en: "Turn on browser alerts and check recent updates here" },
  ...
  "nav.notify.empty": { zh: "还没有通知。保存歌曲或生成完成后，会在这里出现。", en: "No notifications yet. Saved songs and finished generations will appear here." },
