...
export const DICT = {
  ...
  "share.tagline":     { zh: "把一首小歌分享出去。", en: "Share a little song." },
  ...
  "auth.local_creator_unavailable": {
    zh: "暂时没能进入访客模式，请稍后再试。",
    en: "Couldn't start guest mode right now. Try again in a moment.",
  },
  "auth.songs": {
    zh: "作品",
    en: "Songs",
  ...
  "me.notes.refill_default": { zh: "访客模式有一次免费 5 枚；用完后请登录继续。", en: "Guest mode gets 5 free notes once. Sign in to continue after that." },
  ...
  "me.mobile.title":       { zh: "我的", en: "Me" },
  "me.mobile.drawer":      { zh: "小舱", en: "Pocket panel" },
  "me.mobile.open":        { zh: "展开", en: "Open" },
  "me.mobile.notes":       { zh: "音磅", en: "Notes" },
  "me.mobile.settings":    { zh: "设置", en: "Settings" },
  ...
  "checkout.murmur_notes":       { zh: "音磅", en: "Notes" },
