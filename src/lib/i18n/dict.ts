...
export const DICT = {
  ...
  "nav.notify.desc":   { zh: "保存、生成和测试提醒，会在这里安静收着。", en: "Saved songs, finished generations, and test alerts land here quietly." },
  "nav.notify.enabled": { zh: "开着。曲子酿好时，会轻轻叫你。", en: "On. We'll quietly ping you when a vibe is ready." },
  ...
  "nav.notify.test.blocked": { zh: "浏览器系统提醒被拦住了，但站内通知已经可用。", en: "Browser alerts are blocked, but in-app notifications are working." },
