...
export const DICT = {
  ...
  "share.byline":      { zh: "由 Estherscanon 创作", en: "By Estherscanon" },
  ...
  "hum.login_wall.detail":  { zh: "前测期间，登录后可不限量体验。正式收费策略上线前会调整。", en: "During the preview, signing in unlocks unlimited testing. This will change before paid launch." },
  ...
  "me.notes.unlimited":    { zh: "前测期间不限量体验；正式发布前会调整。", en: "Unlimited during the preview; this will change before launch." },
  "me.notes.signed_in":    { zh: "前测中 · 不限量体验", en: "Preview · unlimited testing" },
