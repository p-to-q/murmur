...
export const DICT = {
  ...
  "nav.notify.denied": { zh: "提醒被浏览器拦住了", en: "Notifications are blocked" },
  ...
  "nav.notify.push_test.title": { zh: "你好，{name}", en: "Hello, {name}" },
  "nav.notify.push_test.body": { zh: "Murmur 的推送提醒已经连上了。", en: "Murmur push notifications are connected on this device." },
  "nav.notify.song_generated.title": { zh: "版本已酿好", en: "Vibes ready" },
  "nav.notify.song_generated.body_single": { zh: "一个新版本已经酿好，可以回到谱室听听。", en: "A new vibe is ready in Studio." },
  "nav.notify.song_generated.body_all": { zh: "这一批版本都酿好了，可以去谱室听听。", en: "All vibes are ready in Studio." },
  "nav.notify.song_generated.body_partial": { zh: "{totalCount} 个版本里已有 {readyCount} 个酿好，可以去谱室听听。", en: "{readyCount} of {totalCount} vibes are ready in Studio." },
  ...
  "nav.notify.song_saved.body_named": { zh: "《{title}》已经收好，可以从藏歌里随时打开。", en: "\"{title}\" is tucked away and ready to reopen from your Gallery." },
  "nav.notify.daily_digest.title": { zh: "今天也想哼一句吗？", en: "Feel like humming today?" },
  "nav.notify.daily_digest.body": { zh: "藏歌里的小歌还在等你，或者从一句新的哼唱开始。", en: "Your saved songs are waiting — or start with a fresh hum." },
  ...
  "hum.resume.title": { zh: "上一段哼唱还在", en: "Your last take is ready" },
  "hum.resume.detail": { zh: "录音仍安全保存在这台设备上。继续后会沿用原来的处理任务，不需要重新哼唱。", en: "The recording is still safe on this device. Continue the same operation without humming again." },
  "hum.resume.cta": { zh: "继续上一段录音", en: "Continue last recording" },
  ...
  "hum.proc.mic":      { zh: "正在打开麦克风…", en: "Opening your microphone…" },
  ...
  "hum.client_fallback.toast": { zh: "已使用本地分析，效果可能有所不同。", en: "Used local analysis — quality may vary." },
  ...
  "studio.save_timeout":   { zh: "保存等太久了。草稿还在这里，可以再试一次。", en: "Save is taking too long. Your draft is still here — try again." },
  ...
  "studio.magenta.failed": { zh: "这一版没酿成。可以重试这一版，或者回去选已经完成的版本。", en: "This take did not finish. Retry it or choose another ready take." },
  "studio.magenta.retry": { zh: "重试这一版", en: "Retry this take" },
  "studio.magenta.choose_another": { zh: "换一个已完成版本", en: "Choose another take" },
  ...
  "song.export.ok":           { zh: "已开始下载", en: "Download started" },
  ...
  "public_song.play_failed":  { zh: "暂时没能开始播放，请再试一次。", en: "Couldn't start audio. Please try again." },
  ...
  "me.notifications.helper": { zh: "保存、生成和测试提醒，会在这里出现。", en: "Saved songs, finished generations, and test alerts will appear here." },
  "me.notifications.placeholder": { zh: "还没有通知。保存小歌或版本酿好后，会在这里出现。", en: "No notifications yet. Saved songs and finished vibes will appear here." },
  ...
  "topup.search.placeholder": { zh: "搜索套餐、价格或音磅", en: "Search packs, prices, or notes" },
  "topup.search.empty": { zh: "没有匹配的补给项目", en: "No matching top-up items." },
  "topup.share":       { zh: "分享",       en: "Share" },
  "topup.share.done":  { zh: "补给页已分享", en: "Top up link shared" },
  "topup.share.copied": { zh: "补给页链接已复制", en: "Top up link copied" },
  "topup.share.failed": { zh: "无法分享补给页", en: "Couldn't share this link" },
  ...
  "topup.24h":                   { zh: "24 小时",                  en: "24h" },
  "topup.balance_chart":         { zh: "音磅余额走势",              en: "Notes balance chart" },
  ...
  "topup.cta.sign_in":           { zh: "登录后买 {notes} 颗 — {price}", en: "Sign in to buy {notes} notes — {price}" },
  "topup.sign_in_hint":          { zh: "购买会绑定到注册账号，音磅才能跨设备同步。", en: "Purchases attach to a registered account so your notes can sync." },
  ...
  "checkout.request_timeout":    { zh: "支付页打开得太久了。还没有扣款，可以直接再试一次。", en: "Checkout is taking too long. Nothing was charged — try again." },
