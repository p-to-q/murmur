...
export const DICT = {
  ...
  "nav.login.reward":  { zh: "领取 {notes} 音磅", en: "Claim {notes} welcome notes" },
  "nav.share":         { zh: "分享 Murmur", en: "Share Murmur" },
  "nav.share.reward":  { zh: "各得 {notes} 音磅", en: "{notes} notes for both" },
  "share.tagline":     { zh: "创造值得分享的快乐。", en: "Create joy worth sharing." },
  "share.google":      { zh: "使用Google登录",    en: "Sign in with Google" },
  "share.logged_in":   { zh: "已登录", en: "Already logged in" },
  ...
  "share.copied_short": { zh: "已复制", en: "Copied" },
  ...
  "checkout.awaiting_payment_hint": { zh: "支付完成后会自动回到这里；也可关闭标签页稍后再来。", en: "When you finish, you'll return here automatically. You can also close the tab and come back." },
