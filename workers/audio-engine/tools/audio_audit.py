...
def main() -> int:
    ...
    parser.add_argument(
      "--provider",
      default="auto",
      choices=["auto", "rmvpe", "pyin", "swiftf0", "yin", "parselmouth"],
    ...
    parser.add_argument(
      "--all-providers",
      action="store_true",
      help="Run the audit across auto, rmvpe, swiftf0, pyin, yin, and parselmouth for side-by-side comparison",
    )
    parser.add_argument(
      "--strict",
      action="store_true",
    ...
    providers = ["auto", "rmvpe", "swiftf0", "pyin", "yin", "parselmouth"] if args.all_providers else [args.provider]
    runs: list[dict[str, object]] = []
