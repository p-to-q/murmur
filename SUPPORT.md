...
Use the smallest surface that fits the problem:

- Bug: open a bug report with reproduction steps and any support code.
...
Maintainers may close issues that are support requests without reproduction,
duplicates, or requests that sit outside Murmur's scope.
