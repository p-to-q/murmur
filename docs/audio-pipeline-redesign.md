...
- [diagnosis-2026-06.md](archive/diagnosis-2026-06.md) for the factual current-state
  audio pipeline
- [research-2026-06.md](archive/research-2026-06.md) for external research and
...
- [phase-1-server-transcribe.md](archive/phase-plans/phase-1-server-transcribe.md)
  for the first server-authoritative transcription cut
- [phase-1-hum-surface.md](archive/phase-plans/phase-1-hum-surface.md) for
...
1. Current product and pipeline reality:
   [diagnosis-2026-06.md](archive/diagnosis-2026-06.md)
2. Research and borrowing directions:
   [research-2026-06.md](archive/research-2026-06.md)
